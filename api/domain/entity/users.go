...
var UserWhere = struct {
	...
	AuthID:        whereHelperstring{field: "`users`.`auth_id`"},
	RandID:        whereHelperstring{field: "`users`.`rand_id`"},
...
var UserRels = struct {
	Beautician                 string
	BeauticianBeauticianMenus  string
...
type userR struct {
	Beautician                 *Beautician
	BeauticianBeauticianMenus  BeauticianMenuSlice
...
func (o *User) Beautician(mods ...qm.QueryMod) beauticianQuery {
...
// BeauticianBeauticianMenus retrieves all the beautician_menu's BeauticianMenus with an executor via beautician_id column.
func (o *User) BeauticianBeauticianMenus(mods ...qm.QueryMod) beauticianMenuQuery {
...
// BeauticianBeauticianSalons retrieves all the beautician_salon's BeauticianSalons with an executor via beautician_id column.
func (o *User) BeauticianBeauticianSalons(mods ...qm.QueryMod) beauticianSalonQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`beautician_salons`.`beautician_id`=?", o.ID),
	)
...
// BeauticianReservations retrieves all the reservation's Reservations with an executor via beautician_id column.
func (o *User) BeauticianReservations(mods ...qm.QueryMod) reservationQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (o *User) Reservations(mods ...qm.QueryMod) reservationQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`reservations`.`user_id`=?", o.ID),
	)
...
func (userL) LoadBeautician(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(qm.From(`beauticians`), qm.WhereIn(`beauticians.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadBeauticianBeauticianMenus allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadBeauticianBeauticianMenus(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		object.R.BeauticianBeauticianMenus = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.BeauticianID {
				local.R.BeauticianBeauticianMenus = append(local.R.BeauticianBeauticianMenus, foreign)
				if foreign.R == nil {
					foreign.R = &beauticianMenuR{}
				}
...
// LoadBeauticianBeauticianSalons allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadBeauticianBeauticianSalons(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(qm.From(`beautician_salons`), qm.WhereIn(`beautician_salons.beautician_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.BeauticianBeauticianSalons = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.BeauticianID {
				local.R.BeauticianBeauticianSalons = append(local.R.BeauticianBeauticianSalons, foreign)
				if foreign.R == nil {
					foreign.R = &beauticianSalonR{}
				}
				foreign.R.Beautician = local
...
// LoadBeauticianReservations allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadBeauticianReservations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		object.R.BeauticianReservations = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.BeauticianID {
				local.R.BeauticianReservations = append(local.R.BeauticianReservations, foreign)
				if foreign.R == nil {
					foreign.R = &reservationR{}
				}
				foreign.R.Beautician = local
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadReservations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(qm.From(`reservations`), qm.WhereIn(`reservations.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) SetBeautician(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Beautician) error {
	var err error
	...
	if insert {
		...
		updateQuery := fmt.Sprintf(
			"UPDATE `beauticians` SET %s WHERE %s",
...
// AddBeauticianBeauticianMenus adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.BeauticianBeauticianMenus.
// Sets related.R.Beautician appropriately.
func (o *User) AddBeauticianBeauticianMenus(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*BeauticianMenu) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			BeauticianBeauticianMenus: related,
		}
	} else {
		o.R.BeauticianBeauticianMenus = append(o.R.BeauticianBeauticianMenus, related...)
	}
...
// AddBeauticianBeauticianSalons adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.BeauticianBeauticianSalons.
// Sets related.R.Beautician appropriately.
func (o *User) AddBeauticianBeauticianSalons(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*BeauticianSalon) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.BeauticianID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			BeauticianBeauticianSalons: related,
		}
	} else {
		o.R.BeauticianBeauticianSalons = append(o.R.BeauticianBeauticianSalons, related...)
	}
...
// AddBeauticianReservations adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.BeauticianReservations.
// Sets related.R.Beautician appropriately.
func (o *User) AddBeauticianReservations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Reservation) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.BeauticianID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			BeauticianReservations: related,
		}
	} else {
		o.R.BeauticianReservations = append(o.R.BeauticianReservations, related...)
	}
...
func (o *User) AddReservations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Reservation) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
