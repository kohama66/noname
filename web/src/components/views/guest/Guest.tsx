    ...
    <article className="chooses">
      ...
      <div className="chooses-contents-wrapper">
        ...
        <div className="chooses-contents">
          ...
          <ChoosePlate text={"美容師から選ぶ"} image={"img/3.png"} path={"/beautician"} checked={props.checkedBeautician} />
          <ChoosePlate text={"メニューから選ぶ"} image={"img/2.png"} path={"/menu"} checked={props.checkedMenu}/>
